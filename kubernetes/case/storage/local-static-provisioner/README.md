...
* we recommend to use [qemu machine](../../../../essential/linux/qemu/README.md) because we will modify the devices: /dev/loopX
...
1. optional, [create centos 8 with qemu](../../../../essential/linux/qemu/create.centos.8.with.qemu.md)
